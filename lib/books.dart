                              ...
                              child: Column(
                                children:<Widget>[
                                  Text("Name: Guide through"
                                      "\n Express Entry",style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold),),
                                  Text("Pages: 45",style: TextStyle(fontSize: 20,),),
                                  Text("Author: Keshav",style: TextStyle(fontSize: 20),),
                                  Text("Context: This book will "
                                      "\n guide you through "
                                      "\n all the needs and"
                                      "\n procedure to grab "
                                      "\n chance to be PR of \n Canada through"
                                      "\n Express Entry mode \nand Much More... ",style: TextStyle(fontSize: 20),),
                                ...
                                Padding(
                                  ...
                                  child: Container(
                                    child: Column(
                                      children:<Widget>[
                                        Text("Name: Guide through"
                                            "\n PNP",style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold),),
                                        Text("Pages: 45",style: TextStyle(fontSize: 20,),),
                                        Text("Author: Keshav",style: TextStyle(fontSize: 20),),
                                        Text("Context: This book will "
                                            "\n guide you through "
